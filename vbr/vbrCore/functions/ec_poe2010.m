function [ VBR ] = ec_poe2010( VBR )
  ...
  % hydrous 100 axis
    S_H100 = params.S_H100; % S/m   
    Va_H100 = params.Va_H100; % cc/mol
    H_H100 = params.H_H100 + Va_H100.*P; % eV
    a_H100 = params.a_H100; % unitless
    r = params.r_H100; % unitless
    k = params.k_H100; % eV/(mol*K)
    
    % hydrous 010 axis
    S_H010 = params.S_H010; % S/m 
    Va_H010 = params.Va_H010; % cc/mol
    H_H010 = params.H_H010 + Va_H010.*P; % eV
    a_H010 = params.a_H010; % unitless
    
    % hydrous 001 axis
    S_H001 = params.S_H001; % S/m 
    Va_H001 = params.Va_H001; % cc/mol
    H_H001 = params.H_H001 + Va_H001.*P; % eV
    a_H001 = params.a_H001; % unitless
    
%   Anhydrous params 
    S_A100 = params.S_A100; % S/m 
    Va_A100 = params.Va_A100; % cc/mol
    H_A100 = params.H_A100 + Va_A100.*P; % eV
    
    S_A010 = params.S_A010; % S/m
    Va_A010 = params.Va_A010; % cc/mol
    H_A010 = params.H_A010 + Va_A010.*P; % eV
    
    S_A001 = params.S_A001; % S/m
    Va_A001 = params.Va_A001; % cc/mol
    H_A001 = params.H_A001 + Va_A001.*P; % eV
  ...
  % calculate hydrous arrhenius relation for each crystal axis (wt percent)
